...
fishing::fishing(CaptureWindow *aCapture, SocketIO *aSock) : BaseAction(aCapture, aSock)
{
    m_sActionName = "FISHING";
}

void fishing::init(QStringList &asListParam)
{
...
bool fishing::logic(QStringList &asListParam)
{
//    cv::Mat mat;
//    cv::Mat mat2;
//    cv::Point _point;
...
bool fishing::recognizeKey(int aType)
{
...
void fishing::setCell(int aiValue)
{
